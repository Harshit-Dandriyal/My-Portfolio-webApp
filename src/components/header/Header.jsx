    ...
    <>
      <section className="section-1 header__container section__padding">
        <main className="intro-page">
          ...
          <h1 arial-label="Hi i'm Harshit Dandriyal, web Junior full-stack developer">
            <span className={`${letterClass} H`}>H</span>
            <span className={`${letterClass} _12 I`}>i</span>
            <span className={`${letterClass} _13 HI`}>,</span>
            <br />
