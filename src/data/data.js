...
const socialIcons = [
  {
    ...
    url: 'https://github.com/Harshit-Dandriyal',
  },
  {
    icon: <FiYoutube className="icon switch__color" />,
    url: 'https://www.youtube.com/channel/UCX9mJ46Pkwb5AMErdRollew',
  },
  {
    icon: <GrTwitter className="icon switch__color" />,
    url: 'https://twitter.com/coder_dandriyal',
  },
  {
    icon: <GrInstagram className="icon switch__color" />,
    url: 'https://www.instagram.com/dandriyal.harshit/?next=%2F',
  },
  {
    icon: <FiLinkedin className="icon switch__color" />,
    url: 'https://www.linkedin.com/in/harshit-dandriyal-98866419a/',
  },
]
